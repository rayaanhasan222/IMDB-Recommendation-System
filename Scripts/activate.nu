...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\rayaa\PycharmProjects\pandas_project\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\rayaa\PycharmProjects\pandas_project\venv\Scripts\deactivate.nu'
